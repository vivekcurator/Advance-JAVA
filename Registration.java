...
class MyFrame 
	...
	private JTextArea tadd; 
        ...
        private JComboBox numb;
        private JLabel sem;
        private JComboBox semb;
        private JTextField tcont;
        private JLabel cont;
	...
	private String years[] 
        ...
        private String branches[]
                = { "CSE", "ECE", "MECH","INDS", "BIOT", "CIVE", "ITE"};
	...
	{ 
		...
		rollno.setLocation(100, 350); 
		c.add(rollno); 

		trollno = new JTextField(); 
		trollno.setFont(new Font("Arial", Font.PLAIN, 15)); 
		trollno.setSize(190, 20); 
		trollno.setLocation(200, 350); 
		c.add(trollno);
                
                branch = new JLabel("Branch"); 
		branch.setFont(new Font("Arial", Font.PLAIN, 20)); 
		branch.setSize(100, 20); 
		branch.setLocation(100, 400); 
		c.add(branch); 

		numb = new JComboBox(branches); 
		numb.setFont(new Font("Arial", Font.PLAIN, 15)); 
		numb.setSize(50, 20); 
		numb.setLocation(200, 400); 
		c.add(numb);
                
                sem = new JLabel("Sem"); 
		sem.setFont(new Font("Arial", Font.PLAIN, 20)); 
		sem.setSize(100, 20); 
		sem.setLocation(100, 450); 
		c.add(sem); 

		semb = new JComboBox(sems); 
		semb.setFont(new Font("Arial", Font.PLAIN, 15)); 
		semb.setSize(50, 20); 
		semb.setLocation(200, 450); 
		c.add(semb);
                
                cont = new JLabel("Contact"); 
		cont.setFont(new Font("Arial", Font.PLAIN, 20)); 
		cont.setSize(100, 20); 
		cont.setLocation(100, 500); 
		c.add(cont); 

		tcont = new JTextField(); 
		tcont.setFont(new Font("Arial", Font.PLAIN, 15)); 
		tcont.setSize(190, 20); 
		tcont.setLocation(200, 500); 
		c.add(tcont);
                
                email = new JLabel("Email"); 
		email.setFont(new Font("Arial", Font.PLAIN, 20)); 
		email.setSize(100, 20); 
		email.setLocation(100, 550); 
		c.add(email); 

		temail = new JTextField(); 
		temail.setFont(new Font("Arial", Font.PLAIN, 15)); 
		temail.setSize(190, 20); 
		temail.setLocation(200, 550); 
		c.add(temail);
		...
		if (e.getSource() == sub) { 
			if (term.isSelected()) { 
				...
				String data3 = "Address : " + tadd.getText() + "\n";
					...
					+ trollno.getText() + "\n"
					+ "Branch : "
					+ numb.getSelectedItem() + "\n"
                                        + "Semester : "
					+ semb.getSelectedItem() + "\n"
                                        + "Contact : "
					+ tcont.getText() + "\n"
                                        + "Email : "
					+ temail.getText() + "\n";
			...
			resadd.setText(def);
                        trollno.setText(def);
                        numb.setSelectedIndex(0); 
                        semb.setSelectedIndex(0); 
                        cont.setText(def);
                        temail.setText(def);
                } 
	} 
